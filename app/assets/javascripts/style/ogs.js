...
+function($, window){
  ...
  // Config application
  //
  ogs.config = function(options) {
    //$.extend(true, ogs.defaults, options);

    // Rteurn config value
    if ( typeof options === 'string' ) {
      return ogs.defaults[options];
    }
    ...
    if ( $('[data-provide~="map"]').length && window["google.maps.Map"] === undefined ) {
      $.getScript("https://maps.googleapis.com/maps/api/js?key="+ ogs.defaults.googleApiKey +"&callback=ogs.map");
    }


    // Google Analytics
    //
    if ( ogs.defaults.googleAnalyticsId ) {
      (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
      (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),
      m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)
      })(window,document,'script','https://www.google-analytics.com/analytics.js','ga');

      ga('create', ogs.defaults.googleAnalyticsId, 'auto');
      ga('send', 'pageview');
    }
    ...
    if ( $('[data-provide~="recaptcha"]').length && window["grecaptcha"] === undefined ) {
      ...
      if ( ogs.defaults.reCaptchaLanguage != '' ) {
        url += '&hl=' + ogs.defaults.reCaptchaLanguage;
      }
      $.getScript(url);
    }
  ...
  ogs.parallax = function() {
    ...
    $('[data-parallax]').each(function() {
      ...
      options = $.extend( options, ogs.getDataOptions(parallax));
  ...
  ogs.map = function() {
    ...
    $('[data-provide~="map"]').each(function() {
      ...
      setting = $.extend(setting, ogs.getDataOptions($(this)));
  ...
  // Google reCAPTCHA
  //----------------------------------------------------/
  ogs.recaptcha = function() {
    $('[data-provide~="recaptcha"]').each(function() {

      var options = {
        sitekey: ogs.defaults.reCaptchaSiteKey
      }

      options = $.extend(options, ogs.getDataOptions($(this)));
  ...
  ogs.carousel = function() {
    ...
    $('.swiper-container').each(function(){
      ...
      options = $.extend( options, ogs.getDataOptions(swiper));
  ...
  ogs.typed = function() {
    ...
    $('[data-type]').each(function(){
      ...
      options = $.extend( options, ogs.getDataOptions(el) );
  ...
  //
  ogs.getDataOptions = function(el, castList) {
    var options = {};

    $.each( $(el).data(), function(key, value){

      key = ogs.dataToOption(key);
  ...
  //
  ogs.optionToData = function(name) {
  ...
  //
  ogs.dataToOption = function(name) {
